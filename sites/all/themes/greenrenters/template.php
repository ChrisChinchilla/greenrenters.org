...
if (theme_get_setting('color_enable_schemes') == 'on') {
  drupal_add_css(drupal_get_path('theme', 'greenrenters') .'/css/theme/'. get_at_colors(), 'theme');
}
 ...
 */
/*
function greenrenters_preprocess(&$vars, $hook) {
 ...
 */
/*
function greenrenters_preprocess_page(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/
 ...
 */
/*
function greenrenters_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/
 ...
 */
/*
function greenrenters_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/
 ...
 */
/*
function greenrenters_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/
