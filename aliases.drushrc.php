...
'path-aliases' => array(
	...
	'%dump' => '/Users/chrisward/Downloads/sql-sync-dev-local.sql',
));

// Production environment.
$aliases['prod'] = array(
  //'remote-host' => 'hollows2',
  // Always use deployer user so that tmp SQL files can be shared.
  'remote-user' => 'deployer',
  'root' => '/var/www/hollows.org.au/current/app',
  'uri' => 'greenrenters.org',
  'path-aliases' => array('%dump-dir' => '/var/tmp'),
);
